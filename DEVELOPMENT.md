...
```bash
git remote add encore encore://construction-pareto-analyzer-enai
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/construction-pareto-analyzer-enai/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/construction-pareto-analyzer-enai/settings/integrations/github)
