 ...
 */
import { getAnalysisData as api_analysis_get_data_getAnalysisData } from "~backend/analysis/get_data";
import { getWBSData as api_analysis_get_wbs_data_getWBSData } from "~backend/analysis/get_wbs_data";
import { processSpreadsheet as api_analysis_process_processSpreadsheet } from "~backend/analysis/process";
...
export namespace analysis {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getWBSData = this.getWBSData.bind(this)
            this.processSpreadsheet = this.processSpreadsheet.bind(this)
        }

        /**
         * Retrieves processed analysis data for a project.
         */
        public async getAnalysisData(params: { projectId: string }): Promise<ResponseType<typeof api_analysis_get_data_getAnalysisData>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analysis/${encodeURIComponent(params.projectId)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analysis_get_data_getAnalysisData>
        }

        /**
         * Retrieves WBS-level aggregated data for Pareto analysis.
         */
        public async getWBSData(params: RequestType<typeof api_analysis_get_wbs_data_getWBSData>): Promise<ResponseType<typeof api_analysis_get_wbs_data_getWBSData>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                level:          String(params.level),
                parentItemCode: params.parentItemCode,
            })

            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analysis/${encodeURIComponent(params.projectId)}/wbs`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analysis_get_wbs_data_getWBSData>
        }

        /**
         * Processes uploaded spreadsheet and performs Pareto analysis.
         */
        public async processSpreadsheet(params: RequestType<typeof api_analysis_process_processSpreadsheet>): Promise<ResponseType<typeof api_analysis_process_processSpreadsheet>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analysis/process`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analysis_process_processSpreadsheet>
        }
    }
}
...
export namespace insights {
    ...
    export class ServiceClient {
        ...
        public async generateInsights(params: RequestType<typeof api_insights_generate_generateInsights>): Promise<ResponseType<typeof api_insights_generate_generateInsights>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/insights/generate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_insights_generate_generateInsights>
        }

        /**
         * Retrieves AI insights for a project.
         */
        public async getInsights(params: { projectId: string }): Promise<ResponseType<typeof api_insights_get_insights_getInsights>> {
            // Now make the actual call to the API
...
export namespace projects {
    ...
    export class ServiceClient {
         ...
         */
        public async deleteProject(params: { projectId: string }): Promise<ResponseType<typeof api_projects_delete_deleteProject>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/projects/${encodeURIComponent(params.projectId)}`, {method: "DELETE", body: undefined})
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { uploadFile as api_upload_upload_uploadFile } from "~backend/upload/upload";
...
export namespace upload {
    ...
    export class ServiceClient {
         ...
         */
        public async uploadFile(params: RequestType<typeof api_upload_upload_uploadFile>): Promise<ResponseType<typeof api_upload_upload_uploadFile>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_upload_upload_uploadFile>
        }
    }
}
